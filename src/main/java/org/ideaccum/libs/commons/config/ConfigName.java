 ...
 * 尚、サブクラスとしてプロパティアクセスキークラスを実装する際は{@link org.ideaccum.libs.commons.config#ConfigName(String)}コンストラクタをprotectedレベルで設置して下さい(あくまでも列挙フィールドインスタンス化の目的であり、publicとはしない)。<br>
 * </p>
 * 
 * @author Kitagawa<br>
 * 
